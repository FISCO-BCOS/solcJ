...
pragma solidity >=0.5.0 <0.8.20;Points
pragma experimental ABIEncoderV2;

/**
 *   @title WeCrossProxy Contract
 *   @author WeCross team
 *   @notice WeCross 跨链平台的代理合约
 *   @dev call有withXa是跨链事务内使用方法， call没有WithXa的后缀是事务外方法
 *   v1.0.0
...
contract WeCrossProxy {
    ...
    /**
    *   @notice 动态部署合约方法
    *   @dev 开发者可以使用这个动态部署合约方法进行动态部署合约
    *   @param _bin 合约编译后的字节码
    *   @return addr 返回合约部署的地址
    */
