...
public class Solc {
    ...
    private String getSolcDir(boolean sm, Version version) {
        ...
        // /native/sm/win/0.8.11/solc/
        return "/native/" + (sm ? "sm/" : "ecdsa/") + getOS() + File.separator + version.toString() + File.separator + "solc" + File.separator;
    }
    ...
    private String getOS() {
        ...
        if (osName.contains("win")) {
            ...
            throw new RuntimeException("Can't find solc compiler, only support Windows, unrecognized OS: " + osName);
        }
    }
